...
<td><%=rec.getBackupTime()%></td>
<td align="left"><span style="word-warp:break-word;word-break:break-all"><%=msg.getMemo() %></span></td>
</tr>
<%
}
%>
