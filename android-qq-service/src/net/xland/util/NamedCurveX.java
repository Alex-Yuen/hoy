 ...
 */
public final class NamedCurveX extends ECParameterSpec {
    ...
    private NamedCurveX(String name, ObjectIdentifier oid, EllipticCurve curve,
    ...
    public static ECParameterSpec getECParameterSpec(String name) {
        NamedCurveX spec = oidMap.get(name);
    ...
    private static final Map<String,NamedCurveX> oidMap =
                                        new LinkedHashMap<String,NamedCurveX>();
    private static final Map<String,NamedCurveX> nameMap =
                                        new HashMap<String,NamedCurveX>();
    private static final Map<Integer,NamedCurveX> lengthMap =
                                        new HashMap<Integer,NamedCurveX>();
    ...
    private static void add(String name, String soid, int type, String sfield,
        ...
        try {
            ...
            NamedCurveX params = new NamedCurveX(name, oid, curve, g, bi(n), h);
