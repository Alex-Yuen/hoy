...
//						logger.info(packet.getSid()+" [SCNULL3] " + sc);
						logger.info(packet.getSid()+" [SEND] " + String.valueOf(Integer.toHexString(packet.getSeq())).toUpperCase()+ "="+ packet.getType() + ":"+ Converts.bytesToHexString(packet.getContent()));
