...
public class EngineMessageType {
	...
	public static final int IM_LOAD_PROXY = 0x1027; //加载代理列表
	public static final int IM_REQUIRE_PROXY = 0x1028;
	public static final int IM_NO_PROXY = 0x1029;
	...
	public static final int OM_CLEAR_PROXY_TBL = 0x2028;
	public static final int OM_ADD_PROXY_TBIT = 0x2029;
	public static final int OM_PROXY_LOADED = 0x202A;
	public static final int OM_REQUIRE_PROXY = 0x202B;
	
	public static final int OM_STATS = 0x202C;
